...
void main() {
  test('proxy strips kelivo metadata before forwarding and stores turn', () async {
    ...
    final tempDir = await Directory.systemTemp.createTemp('kelivo_proxy_test');
    addTearDown(() async {
  ...
  test('proxy accumulates streaming assistant text and stores it', () async {
    ...
    final tempDir = await Directory.systemTemp.createTemp('kelivo_proxy_stream');
    addTearDown(() async {
      if (await tempDir.exists()) {
        await tempDir.delete(recursive: true);
      }
